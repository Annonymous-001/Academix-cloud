  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 opacity-5">
        <div className="absolute inset-0 bg-[radial-gradient(circle_500px_at_50%_200px,theme(colors.blue.100),transparent)] dark:bg-[radial-gradient(circle_500px_at_50%_200px,theme(colors.blue.900/20),transparent)]" />
      </div>
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <div className="flex items-center justify-center space-x-3 mb-4">
            ...
            <span className="text-2xl font-bold">Academix Cloud</span>
          </div>
          ...
          <p className="text-muted-foreground">Join thousands of educational institutions using Academix Cloud</p>
        </div>

        <Card className="shadow-lg border-0 bg-background/80 backdrop-blur-sm">
          <CardHeader className="space-y-1">
            <CardTitle className="text-2xl text-center">Get Started</CardTitle>
            <CardDescription className="text-center">Create your account to start your free trial</CardDescription>
          </CardHeader>
          <CardContent>
